...
CREATE TABLE `Customer` (`id` INT AUTO_INCREMENT NOT NULL, `name` VARCHAR(10) DEFAULT NULL COLLATE utf8_unicode_ci, PRIMARY KEY(`id`)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
